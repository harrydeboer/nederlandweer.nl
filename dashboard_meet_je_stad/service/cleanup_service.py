...
"""The measurements are cleaned with this service. The default cleanup is set a dictionary. """
class CleanupService:
    ...
    """The cleanup is done with the requested cleanup or with the default."""
